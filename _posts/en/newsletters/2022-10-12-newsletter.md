...
with some peers from whom to download blocks (Initial Block Download, IBD).
...
makes `AddrFetch` connections to a some of them,
...
of full outbound connection to fixed seeds?
...
they're not able to supply any other type of address."
  a3link="https://bitcoincore.reviews/26114#l-89"
%}
...
- [LND #6500][] Adds the ability to encrypt the Tor private key on disk
  ...
  Using the flag, `--tor.encryptkey`, encrypts the private key and the
